...
import 'package:flo/constants/String.dart';
...
import 'package:flo/enum/view_state.dart';
import 'package:flo/models/message.dart';
import 'package:flo/models/user.dart';
import 'package:flo/provider/image_upload_provider.dart';
import 'package:flo/resources/chat_methods.dart';
import 'package:flo/resources/storage_methods.dart';
import 'package:flo/screens/callscreens/pickup/pickup_layout.dart';
import 'package:flo/utils/call_utilities.dart';
import 'package:flo/utils/permissions.dart';
...
class _ChatScreenState extends State<ChatScreen> {
          ...
          children: <Widget>[
            ...
            _imageUploadProvider.getViewState == ViewState.LOADING
                ? Container(
                    ...
                    child: SpinKitFadingFour( color: Colors.blue[900],
                   size: 40.0)
                  )
                : Container(),
            chatControls(),
        ...
        children: <Widget>[
          ...
          isWriting
              ...
              : Padding(
                  ...
                  child: Icon(Icons.record_voice_over, color:Colors.teal,),
                ),
          isWriting
              ? Container()
              : GestureDetector(
  ...
  CustomAppBar customAppBar(context) {
    return CustomAppBar(
      ...
      leading: IconButton(
        icon: Icon(
          Icons.arrow_back, color:Colors.teal,
        ),
        onPressed: () {
      ...
      centerTitle: false,
      title: Text(
        widget.receiver.name,style:TextStyle(color: Colors.teal)
      ),
      actions: <Widget>[
        IconButton(
          icon: Icon(
            Icons.video_call, color: Colors.teal,
          ),
          onPressed: () async =>
